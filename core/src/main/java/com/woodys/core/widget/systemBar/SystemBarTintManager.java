...
package com.woodys.core.widget.systemBar;
...
public class SystemBarTintManager {
    ...
    private void setupStatusBarView(Context context, ViewGroup decorViewGroup) {
        ...
        if (null != contentView) {
            contentView.setPadding(0, mConfig.getStatusBarHeight(), 0, 0);
        }
    ...
    private void setupNavBarView(Context context, ViewGroup decorViewGroup) {
        ...
        if (0 < childCount) {
            ...
            if (childView instanceof ViewGroup) {
                ...
                childCount = childViewGroup.getChildCount();
                View contentView = childViewGroup.getChildAt(childCount - 1);
                contentView.setPadding(0, mConfig.getStatusBarHeight(), 0, mConfig.getNavigationBarHeight());
            }
        }
    }
